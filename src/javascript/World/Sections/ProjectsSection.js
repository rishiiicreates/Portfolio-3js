        ...
        this.list = [
            {
                ...
                imageSources:
                [
                    './models/projects/dashmetrics/slideA.png'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
                    href: 'https://github.com/rishiiicreates/DashMetrics-final-.git',
                    x: - 4.8,
                    y: - 3,
            ...
            },
            {
                ...
                imageSources:
                [
                    './models/projects/nftmarketplace/slideA.jpg'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
            ...
            {
                name: 'Nudge (Local Market)',
                imageSources:
                [
                    './models/projects/nudge/slideA.webp'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
            ...
            {
                name: 'Housel (AI Reminder)',
                imageSources:
                [
                    './models/projects/housel/slideA.jpg'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
            ...
            },
            {
                ...
                imageSources:
                [
                    './models/projects/aicontent/slideA.jpg'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
            ...
            },
            {
                ...
                imageSources:
                [
                    './models/projects/defidashboard/slideA.jpg'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
